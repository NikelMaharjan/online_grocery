...
class _CheckingPageState extends State<CheckingPage> {
  ...
  Future<Future> _showConfirmationMessage() async {
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: Icon(Icons.hourglass_bottom), toolbarTextStyle: GoogleFonts.poppinsTextTheme().bodyText2, titleTextStyle: GoogleFonts.poppinsTextTheme().headline6,
        ),
        body: Column(
